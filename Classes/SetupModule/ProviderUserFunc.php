...
namespace Waldhacker\Oauth2Client\SetupModule;
...
class ProviderUserFunc
{
    ...
    public function render(): string
    {
        ...
        if ($hasActiveProviders) {
            $html .= ' <span class="badge badge-success">' . htmlspecialchars($lang->getLL('oauth2Providers.enabled')) . '</span>';
        }
