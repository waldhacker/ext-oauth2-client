...
.. code-block:: bash
   ...
   hydra clients create                               \
      ...
      --callbacks "https://your-typo3-site.example.com/typo3/oauth2/callback/handle?oauth2-provider=hydra&action=callback,https://your-typo3-site.example.com/typo3/login?loginProvider=1616569531&oauth2-provider=hydra&login_status=login&commandLI=attempt,https://your-typo3-site.example.com/_oauth2?oauth2-provider=hydra&tx_oauth2client%5Baction%5D=verify,https://your-typo3-site.example.com/_oauth2?oauth2-provider=hydra&logintype=login"
...
Make sure to replace the following variables:
   ...
   - `callbacks`: Replace `your-typo3-site.example.com` with your TYPO3 installation URL - if you have a multi-site setup, add all site urls with the 4 listed paths (so if you use 2 sites, you should have 8 callback URLs configured)
...
.. code-block:: json

   {
        ...
        "redirect_uris": [
             "https://your-typo3-site.example.com/typo3/oauth2/callback/handle?oauth2-provider=hydra\u0026action=callback",
             "https://your-typo3-site.example.com/typo3/login?loginProvider=1616569531\u0026oauth2-provider=hydra\u0026login_status=login\u0026commandLI=attempt",
             "https://your-typo3-site.example.com/_oauth2?oauth2-provider=hydra\u0026tx_oauth2client%5Baction%5D=verify",
             "https://your-typo3-site.example.com/_oauth2?oauth2-provider=hydra\u0026logintype=login"
        ],
        "response_types": [
             "code",
             "id_token"
